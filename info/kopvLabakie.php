...
<?php
	...
	$query = "SELECT Numurs, Vards, Starts, Finiss, Velo, Dzimums, Gads, Komentars FROM registracija WHERE Starts != '' AND Finiss != '' AND Dzimums = 'V' ORDER BY Finiss-Starts ASC LIMIT 0,30";
